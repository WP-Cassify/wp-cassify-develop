...
require_once __DIR__ . '/classes/wp_cassify_authentication_rule_solver.php';

$mock_cas_object = array(
	'cas_user_id' => 'toto',
	'courriel' => 'toto@my-university.fr'
);
...
// - 
// $condition = '[(CAS{cas_user_id} -EQ "toto") -AND (CAS{courriel} -CONTAINS "my-university.fr")] -OR (CAS{cas_user_id} -STARTWITH "test") -OR [(CAS{cas_user_id} -EQ "toto") -OR (CAS{courriel} -STARTWITH "my-university.fr")]';
$condition = '(CAS{cas_user_id} -EQ "toto")';
// $condition = '(CAS{cas_user_id} -EQ "toto") -AND (CAS{courriel} -CONTAINS "my-university.fr")';
// $condition = '(CAS{cas_user_id} -EQ "toto") -AND (CAS{courriel} -CONTAINS "my-university.fr") -OR (CAS{cas_user_id} -STARTWITH "test")';
